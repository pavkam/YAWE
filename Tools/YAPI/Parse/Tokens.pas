...
type
  TWordType = (wtNotAWord,
    ...
    wtIdentifier, wtOperator, wtTAGcomment);
...
const
  ...
  PropertyDirectives: TTokenTypeSet =
    ...
    // hints
    ttDeprecated, ttLibrary, ttPlatform, ttExperimental,
    // Delphi.Net
    ttAdd, ttRemove
    ];
  ...
  VariableDirectives: TTokenTypeSet = [ttAbsolute, ttDeprecated, ttLibrary, ttPlatform, ttExperimental];
  ...
  ProcedureDirectives: TTokenTypeSet = [ttExternal, ttPascal, ttSafecall, ttAbstract,
    ...
    ttExperimental, ttDeprecated, ttLibrary, ttPlatform, ttStatic, ttFinal, ttVarArgs, ttUnsafe];
  ...
  HintDirectives: TTokenTypeSet  = [ttDeprecated, ttLibrary, ttPlatform, ttExperimental];
  ...
  [ttAbsolute, ttExternal, ttPascal, ttSafecall,
    ...
    ttImplements, ttReintroduce, ttExperimental,
...
type
  ...
  TCommentStyle    = (eNotAComment, eDoubleSlash, eBracketStar, eCurlyBrace
    , eCompilerDirective, eUnknownTAG, eDescriptionTAG, eAuthorTAG, eVersionTAG, eChangesTAG, eDocsTAG
...
const
  ...
  CURLY_COMMENTS: TCommentStyleSet =
    ...
    eAuthorTAG, eVersionTAG, eChangesTAG, eDocsTAG, eTodoTAG, eParamTAG, eParameterIdentifier,
    eReturnTAG, eSeeTAG, eThrowsTAG,eReturn, eAdditionalCommentTAG];
  TAG_COMMENTS: TCommentStyleSet   =
    [eUnknownTAG, eDescriptionTAG, eAuthorTAG, eVersionTAG, eChangesTAG, eDocsTAG, eTodoTAG, 
  ...
  CommentStyleName: array[low(TCommentStyle)..high(TCommentStyle)] of string =
    ...
    , 'eVersionTAG', 'eChangesTAG', 'eDocsTAG', 'eTodoTAG', 'eParamTAG', 'eParameterIdentifier'
