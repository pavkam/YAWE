...
type
  ...
  private
    ...
    function GetExtendedTokenMessage: string;
  public
    ...
    property ExtendedTokenMessage: string Read GetExtendedTokenMessage;
...
function TEParseError.GetExtendedTokenMessage: string;
begin
  Result:=GetTokenMessage;
  if fcToken <> nil then
  begin
    Result := Result + Format(' at [%d,%d]',[fiXPosition,fiYPosition]);
  end;
end;
