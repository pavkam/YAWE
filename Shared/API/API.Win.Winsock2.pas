...
{$I compiler.inc}
{$I windefines.inc}
unit API.Win.Winsock2 platform;
...
{ WSAAccept() and overlapped I/O completion routines. }
type
  ...
  LPCONDITIONPROC = function(lpCallerId: LPWSABUF; lpCallerData: LPWSABUF; lpSQOS, lpGQOS: LPQOS;
...
function WSAErrorMessage(iError: Integer): string;

{ Macro for getting the extension pointers }
...
function getpeername(const s: TSocket; name: PSockAddr; var namelen: Integer): Integer; stdcall;
function getsockname(const s: TSocket; name: PSockAddr; var namelen: Integer): Integer; stdcall;
...
function WSAEnumProtocolsA(lpiProtocols: PInteger; lpProtocolBuffer: LPWSAProtocol_InfoA; lpdwBufferLength: PDWORD): Integer; stdcall;
function WSAEnumProtocolsW(lpiProtocols: PInteger; lpProtocolBuffer: LPWSAProtocol_InfoW; lpdwBufferLength: PDWORD): Integer; stdcall;
function WSAEnumProtocols(lpiProtocols: PInteger; lpProtocolBuffer: LPWSAProtocol_Info; lpdwBufferLength: PDWORD): Integer; stdcall;
...
function WSARecv(s: TSocket; lpBuffers: LPWSABUF; dwBufferCount: DWORD; lpNumberOfBytesRecvd: PDWORD; lpFlags: PDWORD;
  lpOverlapped: LPWSAOVERLAPPED; lpCompletionRoutine: LPWSAOVERLAPPED_COMPLETION_ROUTINE): Integer; stdcall;
function WSARecvDisconnect(s: TSocket; lpInboundDisconnectData: LPWSABUF): Integer; stdcall;
function WSARecvFrom(s: TSocket; lpBuffers: LPWSABUF; dwBufferCount: DWORD; lpNumberOfBytesRecvd: PDWORD; lpFlags: PDWORD;
...
function WSASend(s: TSocket; lpBuffers: LPWSABUF; dwBufferCount: DWORD; lpNumberOfBytesSent: PDWORD; dwFlags: DWORD;
  lpOverlapped: LPWSAOVERLAPPED; lpCompletionRoutine: LPWSAOVERLAPPED_COMPLETION_ROUTINE): Integer; stdcall;
function WSASendDisconnect(s: TSocket; lpOutboundDisconnectData: LPWSABUF): Integer; stdcall;
function WSASendTo(s: TSocket; lpBuffers: LPWSABUF; dwBufferCount: DWORD; lpNumberOfBytesSent: PDWORD; dwFlags: DWORD;
...
function WSAErrorMessage(iError: Integer): string;
begin
  Result := SysErrorMessage(iError) + ' (' + IntToStr(iError) + ')';
end;
