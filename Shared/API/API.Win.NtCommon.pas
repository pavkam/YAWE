...
{$I compiler.inc}
{$I windefines.inc}
unit API.Win.NtCommon platform;
...
const
  MASK_DELETE                   = ($00010000);
  MASK_READ_CONTROL             = ($00020000);
  MASK_WRITE_DAC                = ($00040000);
  MASK_WRITE_OWNER              = ($00080000);
  MASK_SYNCHRONIZE              = ($00100000);

  STANDARD_RIGHTS_REQUIRED = ($000F0000);

  STANDARD_RIGHTS_READ     = (MASK_READ_CONTROL);
  STANDARD_RIGHTS_WRITE    = (MASK_READ_CONTROL);
  STANDARD_RIGHTS_EXECUTE  = (MASK_READ_CONTROL);
...
const
  ...
  PROCESS_ALL_ACCESS        = (STANDARD_RIGHTS_REQUIRED or MASK_SYNCHRONIZE or $FFF);
  ...
  THREAD_ALL_ACCESS = (STANDARD_RIGHTS_REQUIRED or MASK_SYNCHRONIZE or $3FF);
  ...
  JOB_OBJECT_ALL_ACCESS              = (STANDARD_RIGHTS_REQUIRED or MASK_SYNCHRONIZE or $1F );
...
const
  ...
  EVENT_ALL_ACCESS   = (STANDARD_RIGHTS_REQUIRED or MASK_SYNCHRONIZE or $3);
  MUTANT_QUERY_STATE = $0001;

  MUTANT_ALL_ACCESS      = (STANDARD_RIGHTS_REQUIRED or MASK_SYNCHRONIZE or MUTANT_QUERY_STATE);
  SEMAPHORE_MODIFY_STATE = $0002;
  SEMAPHORE_ALL_ACCESS   = (STANDARD_RIGHTS_REQUIRED or MASK_SYNCHRONIZE or $3);
...
//
  ...
  TIMER_ALL_ACCESS = (STANDARD_RIGHTS_REQUIRED or MASK_SYNCHRONIZE or TIMER_QUERY_STATE or TIMER_MODIFY_STATE);
...
//
  ...
  FILE_ALL_ACCESS = (STANDARD_RIGHTS_REQUIRED or MASK_SYNCHRONIZE or $1FF);

  FILE_GENERIC_READ = (STANDARD_RIGHTS_READ or FILE_READ_DATA or
    FILE_READ_ATTRIBUTES or FILE_READ_EA or MASK_SYNCHRONIZE);

  FILE_GENERIC_WRITE = (STANDARD_RIGHTS_WRITE or FILE_WRITE_DATA or
    FILE_WRITE_ATTRIBUTES or FILE_WRITE_EA or FILE_APPEND_DATA or MASK_SYNCHRONIZE);

  FILE_GENERIC_EXECUTE = (STANDARD_RIGHTS_EXECUTE or FILE_READ_ATTRIBUTES or
    FILE_EXECUTE or MASK_SYNCHRONIZE);
...
const
  ...
  IO_COMPLETION_ALL_ACCESS   = DWORD(STANDARD_RIGHTS_REQUIRED or MASK_SYNCHRONIZE or $3);
...
const
  ...
  KEY_READ = STANDARD_RIGHTS_READ or KEY_QUERY_VALUE or KEY_ENUMERATE_SUB_KEYS or
    KEY_NOTIFY  and (not MASK_SYNCHRONIZE);

  KEY_WRITE = STANDARD_RIGHTS_WRITE or KEY_SET_VALUE or KEY_CREATE_SUB_KEY and
    (not MASK_SYNCHRONIZE);

  KEY_EXECUTE = KEY_READ and  (not MASK_SYNCHRONIZE);
  ...
  KEY_ALL_ACCESS = STANDARD_RIGHTS_ALL or KEY_QUERY_VALUE or KEY_SET_VALUE or
    ...
    KEY_CREATE_LINK and (not MASK_SYNCHRONIZE);
