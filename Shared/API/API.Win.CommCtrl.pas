...
function InitCommonControlsEx(var ICC: TInitCommonControlsEx): BOOL; stdcall; { Re-defined below }
...
function InitCommonControlsEx(var ICC: TInitCommonControlsEx): BOOL; external cctrl name 'InitCommonControlsEx';
...
begin
  Result := API.Win.Types.HWND( SendMessage(hwnd, TVM_EDITLABEL, 0, Longint(hitem)) );
end;
function TreeView_EditLabelA(hwnd: HWND; hitem: HTreeItem): HWND;
begin
  Result := API.Win.Types.HWND( SendMessageA(hwnd, TVM_EDITLABELA, 0, Longint(hitem)) );
end;
function TreeView_EditLabelW(hwnd: HWND; hitem: HTreeItem): HWND;
begin
  Result := API.Win.Types.HWND( SendMessageW(hwnd, TVM_EDITLABELW, 0, Longint(hitem)) );
end;

function TreeView_GetEditControl(hwnd: HWND): HWND;
begin
  Result := API.Win.Types.HWND( SendMessage(hwnd, TVM_GETEDITCONTROL, 0, 0) );
end;
