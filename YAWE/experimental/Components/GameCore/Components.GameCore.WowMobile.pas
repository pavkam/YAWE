...
type
  ...
  YGaPositionMgr = class(YGaMobileComponent)
    private
      ...
      fFlySpeed: Float;       //added in 2.0.6
      fBackFlySpeed: Float;   //added in 2.0.6
      fTurnRate: Float;
      fAreaGridX: UInt32;
      fAreaGridY: UInt32;
...
procedure YGaPositionMgr.SendRootValue(iValue: UInt32);
var
...
procedure YGaPositionMgr.SendUnroot;
var
 cOutPacket: YNwServerPacket;
begin
...
procedure YGaPositionMgr.SetBackFlySpeed(const Value: Float);
begin
  fBackFlySpeed := Value;
end;

procedure YGaPositionMgr.SetFlySpeed(const Value: Float);
begin
  fFlySpeed := Value;
end;
