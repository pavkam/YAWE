...
type
  ...
  YGaFactory = class(TBaseObject)
    ...
    public
      constructor Create(pFactoryClass: YOpenObjectClass; iCapacity: Int32; const sName: string;
        cCoreObject: TBaseObject; iGrowAmount: Int32 = -1); reintroduce;
...
{ constructor Create }
constructor YGaFactory.Create(pFactoryClass: YOpenObjectClass; iCapacity: Int32; const sName: string;
  cCoreObject: TBaseObject; iGrowAmount: Int32 = -1);
var
  pDataBlock: Pointer;
begin
  inherited Create;
