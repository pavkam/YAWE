...
type
  ...
  TLogHandle = class(TReferencedObject)
    private
      fOwner: TLogManager;
      fName: string;
      fMaximumSize: Int64;
  ...
  TLogManager = class(TReferencedObject)
    private
      fLogs: TStrHashMap;
      fLock: TCriticalSection;
...
begin
  fThread := SysThreadMgr.CreateThread(ProcessAsyncRequests, False,
...
begin
  fMsgThread := SysThreadMgr.CreateThread(ProcessGuiMessages, False,
