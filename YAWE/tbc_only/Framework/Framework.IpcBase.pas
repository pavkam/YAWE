...
type
  ...
  TIpcServer = class(TReferencedObject)
    private
  ...
  TIpcClient = class(TInterfacedObject)
    private
      fPipe: THandle;
      fThread: TThreadHandle;
...
begin
  ...
  fThread := SysThreadMgr.CreateThread(ServePipeRequests, True,
...
begin
  inherited Create;
  fThread := SysThreadMgr.CreateThread(InitiateComm, False, 'Ipc_Client_Thread', False);
end;
