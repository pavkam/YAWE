...
begin
  ...
  SysEventMgr.OnEventRegister := ReportEventRegister;
  SysEventMgr.OnEventUnregister := ReportEventUnregister;
  SysEventMgr.OnEventException := ReportEventError;

  SysThreadMgr.OnThreadException := ReportThreadError;
end;
