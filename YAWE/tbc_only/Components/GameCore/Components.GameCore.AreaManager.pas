...
type
  YGaBaseAreaManager = class(TInterfacedObject)
    protected
      fMaxX: Int32;
      fMaxY: Int32;
      fMinX: Int32;
...
begin
  AllocateInstanceArrayEx(YGaArea, Result, iCount, AreaConstructorInvoke);
end;

procedure YGaAreaManager.FreeAreas(pAreas: Pointer);
begin
  FreeInstanceArray(YGaArea, pAreas, True);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if not IsVectorDistanceWithin(tOldPos, Objects[iX].Vector, VIEW_DISTANCE) and
             IsVectorDistanceWithin(tNewPos, Objects[iX].Vector, VIEW_DISTANCE) then
          begin
    ...
    cObject.Vector := tNewPos;
    cObject.Angle := fAngle;
