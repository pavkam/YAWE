...
{*------------------------------------------------------------------------------
  ...
  @see YDbSerializable
-------------------------------------------------------------------------------}
procedure YGaUnit.ExtractObjectData(const Entry: ISerializable);
begin
...
{*------------------------------------------------------------------------------
  ...
  @see YDbSerializable
-------------------------------------------------------------------------------}
procedure YGaUnit.InjectObjectData(const Entry: ISerializable);
begin
...
begin
  ...
  fUpdateHandle := SysEventMgr.RegisterEvent(UnitLifeTimer, 100, TICK_EXECUTE_INFINITE, 'GaUnit_UnitLifeTimer');
end;
...
@see YDbSerializable
-------------------------------------------------------------------------------}
procedure YGaPetMgr.ExtractObjectData(const Entry: ISerializable);
begin
end;
...
@see YDbSerializable
-------------------------------------------------------------------------------}
procedure YGaPetMgr.InjectObjectData(const Entry: ISerializable);
begin
end;
...
@see YDbSerializable
-------------------------------------------------------------------------------}
procedure YGaStatMgr.ExtractObjectData(const Entry: ISerializable);
begin
end;
...
@see YDbSerializable
-------------------------------------------------------------------------------}
procedure YGaStatMgr.InjectObjectData(const Entry: ISerializable);
begin
end;
