...
type
  ...
  YIoConsole = class(TBaseInterfacedObject, IConsole)
    private
      fCi: TCharInfo;
    ...
    public
      ...
      procedure WriteLSMessage(const sMsg: string; cSelf: TBaseObject);
      procedure WriteLSErrorMessage(const sMsg: string; iError: Int32; cSelf: TBaseObject);
      ...
      procedure WriteUpdateReq(cObj: TBaseObject);
...
begin
  ...
  fThread := SystemThreadManager.CreateThread(CheckConsoleInput, False,
...
procedure YIoConsole.WriteUpdateReq(cObj: TBaseObject);
begin
...
procedure YIoConsole.WriteLSMessage(const sMsg: string; cSelf: TBaseObject);
begin
...
procedure YIoConsole.WriteLSErrorMessage(const sMsg: string; iError: Int32; cSelf: TBaseObject);
begin
