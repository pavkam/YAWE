...
{$IFNDEF WOW_TBC}
  ...
  { Repeat 21 Times }
  __ITEM_FIELD_ENCHANTMENT                        =  21;
  ITEM_FIELD_ENCHANTMENT                          =  OBJECT_END + $0010; { Type: uint32 }
  { ... }

  ITEM_FIELD_PROPERTY_SEED                        =  OBJECT_END + $0025; { Type: uint32 }
  ITEM_FIELD_RANDOM_PROPERTIES_ID                 =  OBJECT_END + $0026; { Type: uint32 }
  ITEM_FIELD_ITEM_TEXT_ID                         =  OBJECT_END + $0027; { Type: uint32 }
  ITEM_FIELD_DURABILITY                           =  OBJECT_END + $0028; { Type: uint32 }
  ITEM_FIELD_MAXDURABILITY                        =  OBJECT_END + $0029; { Type: uint32 }
...
{$IFNDEF WOW_TBC}
  ...
  { Repeat 20 Times }
  __CONTAINER_FIELD_SLOT_1                        =  20;
  CONTAINER_FIELD_SLOT_1                          =  ITEM_END + $0002; { Type: guid }
  { ... }

  { TODO -oAll -cUpdate Fields : There is a mess here....a container should have 32 slots max.,
    but here the size of the space reserved for item guids is just 72 bytes (9 slots). It should
    be 256 bytes. The client works correctly with 256 bytes also. }
  CONTAINER_END                                   =  CONTAINER_FIELD_SLOT_1 + 256;
{$ELSE}
  CONTAINER_START                                 =  ITEM_END;
  CONTAINER_FIELD_NUM_SLOTS                       =  ITEM_END + $0000; { Type: uint32 }
  CONTAINER_ALIGN_PAD                             =  ITEM_END + $0001; { Type: bytes }
  ...
  CONTAINER_END                                   =  CONTAINER_FIELD_SLOT_1 + 120;
{$ENDIF}
{$ENDREGION}
...
{$IFNDEF WOW_TBC}
  ...
  { Repeat 48 Times }
  __UNIT_FIELD_AURA                               =  48;
  UNIT_FIELD_AURA                                 =  OBJECT_END + $0029; { Type: uint32 }
  { ... }


  { Repeat 6 Times }
  __UNIT_FIELD_AURAFLAGS                          =  6;
  UNIT_FIELD_AURAFLAGS                            =  OBJECT_END + $0059; { Type: bytes }
  { ... }


  { Repeat 12 Times }
  __UNIT_FIELD_AURALEVELS                         =  12;
  UNIT_FIELD_AURALEVELS                           =  OBJECT_END + $005F; { Type: bytes }
  { ... }


  { Repeat 12 Times }
  __UNIT_FIELD_AURAAPPLICATIONS                   =  12;
  UNIT_FIELD_AURAAPPLICATIONS                     =  OBJECT_END + $006B; { Type: bytes }
  { ... }

  UNIT_FIELD_AURASTATE                            =  OBJECT_END + $0077; { Type: uint32 }

  { Repeat 2 Times }
  __UNIT_FIELD_BASEATTACKTIME                     =  2;
  UNIT_FIELD_BASEATTACKTIME                       =  OBJECT_END + $0078; { Type: uint32 }
  { ... }

  UNIT_FIELD_RANGEDATTACKTIME                     =  OBJECT_END + $007A; { Type: uint32 }
  UNIT_FIELD_BOUNDINGRADIUS                       =  OBJECT_END + $007B; { Type: float }
  UNIT_FIELD_COMBATREACH                          =  OBJECT_END + $007C; { Type: float }
  UNIT_FIELD_DISPLAYID                            =  OBJECT_END + $007D; { Type: uint32 }
  UNIT_FIELD_NATIVEDISPLAYID                      =  OBJECT_END + $007E; { Type: uint32 }
  UNIT_FIELD_MOUNTDISPLAYID                       =  OBJECT_END + $007F; { Type: uint32 }
  UNIT_FIELD_MINDAMAGE                            =  OBJECT_END + $0080; { Type: float }
  UNIT_FIELD_MAXDAMAGE                            =  OBJECT_END + $0081; { Type: float }
  UNIT_FIELD_MINOFFHANDDAMAGE                     =  OBJECT_END + $0082; { Type: float }
  UNIT_FIELD_MAXOFFHANDDAMAGE                     =  OBJECT_END + $0083; { Type: float }
  UNIT_FIELD_BYTES_1                              =  OBJECT_END + $0084; { Type: bytes }
  UNIT_FIELD_PETNUMBER                            =  OBJECT_END + $0085; { Type: uint32 }
  UNIT_FIELD_PET_NAME_TIMESTAMP                   =  OBJECT_END + $0086; { Type: uint32 }
  UNIT_FIELD_PETEXPERIENCE                        =  OBJECT_END + $0087; { Type: uint32 }
  UNIT_FIELD_PETNEXTLEVELEXP                      =  OBJECT_END + $0088; { Type: uint32 }
  UNIT_DYNAMIC_FLAGS                              =  OBJECT_END + $0089; { Type: uint32 }
  UNIT_CHANNEL_SPELL                              =  OBJECT_END + $008A; { Type: uint32 }
  UNIT_MOD_CAST_SPEED                             =  OBJECT_END + $008B; { Type: float }
  UNIT_CREATED_BY_SPELL                           =  OBJECT_END + $008C; { Type: uint32 }
  UNIT_NPC_FLAGS                                  =  OBJECT_END + $008D; { Type: uint32 }
  UNIT_NPC_EMOTESTATE                             =  OBJECT_END + $008E; { Type: uint32 }
  UNIT_TRAINING_POINTS                            =  OBJECT_END + $008F; { Type: bytes }
  UNIT_FIELD_STAT0                                =  OBJECT_END + $0090; { Type: uint32 }
  UNIT_FIELD_STAT1                                =  OBJECT_END + $0091; { Type: uint32 }
  UNIT_FIELD_STAT2                                =  OBJECT_END + $0092; { Type: uint32 }
  UNIT_FIELD_STAT3                                =  OBJECT_END + $0093; { Type: uint32 }
  UNIT_FIELD_STAT4                                =  OBJECT_END + $0094; { Type: uint32 }

  { Repeat 7 Times }
  __UNIT_FIELD_RESISTANCES                        =  7;
  UNIT_FIELD_RESISTANCES                          =  OBJECT_END + $0095; { Type: uint32 }
  { ... }

  UNIT_FIELD_BASE_MANA                            =  OBJECT_END + $009C; { Type: uint32 }
  UNIT_FIELD_BASE_HEALTH                          =  OBJECT_END + $009D; { Type: uint32 }
  UNIT_FIELD_BYTES_2                              =  OBJECT_END + $009E; { Type: bytes }
  UNIT_FIELD_ATTACK_POWER                         =  OBJECT_END + $009F; { Type: uint32 }
  UNIT_FIELD_ATTACK_POWER_MODS                    =  OBJECT_END + $00A0; { Type: bytes }
  UNIT_FIELD_ATTACK_POWER_MULTIPLIER              =  OBJECT_END + $00A1; { Type: float }
  UNIT_FIELD_RANGED_ATTACK_POWER                  =  OBJECT_END + $00A2; { Type: uint32 }
  UNIT_FIELD_RANGED_ATTACK_POWER_MODS             =  OBJECT_END + $00A3; { Type: bytes }
  UNIT_FIELD_RANGED_ATTACK_POWER_MULTIPLIER       =  OBJECT_END + $00A4; { Type: float }
  UNIT_FIELD_MINRANGEDDAMAGE                      =  OBJECT_END + $00A5; { Type: float }
  UNIT_FIELD_MAXRANGEDDAMAGE                      =  OBJECT_END + $00A6; { Type: float }

  { Repeat 7 Times }
  __UNIT_FIELD_POWER_COST_MODIFIER                =  7;
  UNIT_FIELD_POWER_COST_MODIFIER                  =  OBJECT_END + $00A7; { Type: uint32 }
  { ... }


  { Repeat 7 Times }
  __UNIT_FIELD_POWER_COST_MULTIPLIER              =  7;
  UNIT_FIELD_POWER_COST_MULTIPLIER                =  OBJECT_END + $00AE; { Type: float }
  { ... }

  UNIT_FIELD_PADDING                              =  OBJECT_END + $00B5; { Type: uint32 }
...
{$ELSE}
  ...
  UNIT_FIELD_AURAFLAGS                            =  OBJECT_END + $0061; { Type: bytes }
  { ... }


  { Repeat 14 Times }
  __UNIT_FIELD_AURALEVELS                         =  14;
  UNIT_FIELD_AURALEVELS                           =  OBJECT_END + $0068; { Type: bytes }
  { ... }


  { Repeat 14 Times }
  __UNIT_FIELD_AURAAPPLICATIONS                   =  14;
  UNIT_FIELD_AURAAPPLICATIONS                     =  OBJECT_END + $0076; { Type: bytes }
  { ... }

  UNIT_FIELD_AURASTATE                            =  OBJECT_END + $0084; { Type: uint32 }

  { Repeat 2 Times }
  __UNIT_FIELD_BASEATTACKTIME                     =  2;
  UNIT_FIELD_BASEATTACKTIME                       =  OBJECT_END + $0085; { Type: uint32 }
  { ... }

  UNIT_FIELD_RANGEDATTACKTIME                     =  OBJECT_END + $0087; { Type: uint32 }
  UNIT_FIELD_BOUNDINGRADIUS                       =  OBJECT_END + $0088; { Type: float }
  UNIT_FIELD_COMBATREACH                          =  OBJECT_END + $0089; { Type: float }
  UNIT_FIELD_DISPLAYID                            =  OBJECT_END + $008A; { Type: uint32 }
  UNIT_FIELD_NATIVEDISPLAYID                      =  OBJECT_END + $008B; { Type: uint32 }
  UNIT_FIELD_MOUNTDISPLAYID                       =  OBJECT_END + $008C; { Type: uint32 }
  UNIT_FIELD_MINDAMAGE                            =  OBJECT_END + $008D; { Type: float }
  UNIT_FIELD_MAXDAMAGE                            =  OBJECT_END + $008E; { Type: float }
  UNIT_FIELD_MINOFFHANDDAMAGE                     =  OBJECT_END + $008F; { Type: float }
  UNIT_FIELD_MAXOFFHANDDAMAGE                     =  OBJECT_END + $0090; { Type: float }
  UNIT_FIELD_BYTES_1                              =  OBJECT_END + $0091; { Type: bytes }
  UNIT_FIELD_PETNUMBER                            =  OBJECT_END + $0092; { Type: uint32 }
  UNIT_FIELD_PET_NAME_TIMESTAMP                   =  OBJECT_END + $0093; { Type: uint32 }
  UNIT_FIELD_PETEXPERIENCE                        =  OBJECT_END + $0094; { Type: uint32 }
  UNIT_FIELD_PETNEXTLEVELEXP                      =  OBJECT_END + $0095; { Type: uint32 }
  UNIT_DYNAMIC_FLAGS                              =  OBJECT_END + $0096; { Type: uint32 }
  UNIT_CHANNEL_SPELL                              =  OBJECT_END + $0097; { Type: uint32 }
  UNIT_MOD_CAST_SPEED                             =  OBJECT_END + $0098; { Type: float }
  UNIT_CREATED_BY_SPELL                           =  OBJECT_END + $0099; { Type: uint32 }
  UNIT_NPC_FLAGS                                  =  OBJECT_END + $009A; { Type: uint32 }
  UNIT_NPC_EMOTESTATE                             =  OBJECT_END + $009B; { Type: uint32 }
  UNIT_TRAINING_POINTS                            =  OBJECT_END + $009C; { Type: bytes }
  UNIT_FIELD_STAT0                                =  OBJECT_END + $009D; { Type: uint32 }
  UNIT_FIELD_STAT1                                =  OBJECT_END + $009E; { Type: uint32 }
  UNIT_FIELD_STAT2                                =  OBJECT_END + $009F; { Type: uint32 }
  UNIT_FIELD_STAT3                                =  OBJECT_END + $00A0; { Type: uint32 }
  UNIT_FIELD_STAT4                                =  OBJECT_END + $00A1; { Type: uint32 }

  { Repeat 7 Times }
  __UNIT_FIELD_RESISTANCES                        =  7;
  UNIT_FIELD_RESISTANCES                          =  OBJECT_END + $00A2; { Type: uint32 }
  { ... }

  UNIT_FIELD_BASE_MANA                            =  OBJECT_END + $00A9; { Type: uint32 }
  UNIT_FIELD_BASE_HEALTH                          =  OBJECT_END + $00AA; { Type: uint32 }
  UNIT_FIELD_BYTES_2                              =  OBJECT_END + $00AB; { Type: bytes }
  UNIT_FIELD_ATTACK_POWER                         =  OBJECT_END + $00AC; { Type: uint32 }
  UNIT_FIELD_ATTACK_POWER_MODS                    =  OBJECT_END + $00AD; { Type: bytes }
  UNIT_FIELD_ATTACK_POWER_MULTIPLIER              =  OBJECT_END + $00AE; { Type: float }
  UNIT_FIELD_RANGED_ATTACK_POWER                  =  OBJECT_END + $00AF; { Type: uint32 }
  UNIT_FIELD_RANGED_ATTACK_POWER_MODS             =  OBJECT_END + $00B0; { Type: bytes }
  UNIT_FIELD_RANGED_ATTACK_POWER_MULTIPLIER       =  OBJECT_END + $00B1; { Type: float }
  UNIT_FIELD_MINRANGEDDAMAGE                      =  OBJECT_END + $00B2; { Type: float }
  UNIT_FIELD_MAXRANGEDDAMAGE                      =  OBJECT_END + $00B3; { Type: float }

  { Repeat 7 Times }
  __UNIT_FIELD_POWER_COST_MODIFIER                =  7;
  UNIT_FIELD_POWER_COST_MODIFIER                  =  OBJECT_END + $00B4; { Type: uint32 }
  { ... }


  { Repeat 7 Times }
  __UNIT_FIELD_POWER_COST_MULTIPLIER              =  7;
  UNIT_FIELD_POWER_COST_MULTIPLIER                =  OBJECT_END + $00BB; { Type: float }
  { ... }

  UNIT_END                                        =  UNIT_FIELD_POWER_COST_MULTIPLIER + 7;
{$ENDIF}
{$ENDREGION}
...
{$IFNDEF WOW_TBC}
  ...
  PLAYER_VISIBLE_ITEM_1_CREATOR                   =  UNIT_END + $0046; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_1_0                       =  8;
  PLAYER_VISIBLE_ITEM_1_0                         =  UNIT_END + $0048; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_1_PROPERTIES                =  UNIT_END + $0050; { Type: bytes }
  PLAYER_VISIBLE_ITEM_1_PAD                       =  UNIT_END + $0051; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_2_CREATOR                   =  UNIT_END + $0052; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_2_0                       =  8;
  PLAYER_VISIBLE_ITEM_2_0                         =  UNIT_END + $0054; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_2_PROPERTIES                =  UNIT_END + $005C; { Type: bytes }
  PLAYER_VISIBLE_ITEM_2_PAD                       =  UNIT_END + $005D; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_3_CREATOR                   =  UNIT_END + $005E; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_3_0                       =  8;
  PLAYER_VISIBLE_ITEM_3_0                         =  UNIT_END + $0060; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_3_PROPERTIES                =  UNIT_END + $0068; { Type: bytes }
  PLAYER_VISIBLE_ITEM_3_PAD                       =  UNIT_END + $0069; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_4_CREATOR                   =  UNIT_END + $006A; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_4_0                       =  8;
  PLAYER_VISIBLE_ITEM_4_0                         =  UNIT_END + $006C; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_4_PROPERTIES                =  UNIT_END + $0074; { Type: bytes }
  PLAYER_VISIBLE_ITEM_4_PAD                       =  UNIT_END + $0075; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_5_CREATOR                   =  UNIT_END + $0076; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_5_0                       =  8;
  PLAYER_VISIBLE_ITEM_5_0                         =  UNIT_END + $0078; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_5_PROPERTIES                =  UNIT_END + $0080; { Type: bytes }
  PLAYER_VISIBLE_ITEM_5_PAD                       =  UNIT_END + $0081; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_6_CREATOR                   =  UNIT_END + $0082; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_6_0                       =  8;
  PLAYER_VISIBLE_ITEM_6_0                         =  UNIT_END + $0084; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_6_PROPERTIES                =  UNIT_END + $008C; { Type: bytes }
  PLAYER_VISIBLE_ITEM_6_PAD                       =  UNIT_END + $008D; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_7_CREATOR                   =  UNIT_END + $008E; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_7_0                       =  8;
  PLAYER_VISIBLE_ITEM_7_0                         =  UNIT_END + $0090; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_7_PROPERTIES                =  UNIT_END + $0098; { Type: bytes }
  PLAYER_VISIBLE_ITEM_7_PAD                       =  UNIT_END + $0099; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_8_CREATOR                   =  UNIT_END + $009A; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_8_0                       =  8;
  PLAYER_VISIBLE_ITEM_8_0                         =  UNIT_END + $009C; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_8_PROPERTIES                =  UNIT_END + $00A4; { Type: bytes }
  PLAYER_VISIBLE_ITEM_8_PAD                       =  UNIT_END + $00A5; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_9_CREATOR                   =  UNIT_END + $00A6; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_9_0                       =  8;
  PLAYER_VISIBLE_ITEM_9_0                         =  UNIT_END + $00A8; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_9_PROPERTIES                =  UNIT_END + $00B0; { Type: bytes }
  PLAYER_VISIBLE_ITEM_9_PAD                       =  UNIT_END + $00B1; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_10_CREATOR                  =  UNIT_END + $00B2; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_10_0                      =  8;
  PLAYER_VISIBLE_ITEM_10_0                        =  UNIT_END + $00B4; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_10_PROPERTIES               =  UNIT_END + $00BC; { Type: bytes }
  PLAYER_VISIBLE_ITEM_10_PAD                      =  UNIT_END + $00BD; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_11_CREATOR                  =  UNIT_END + $00BE; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_11_0                      =  8;
  PLAYER_VISIBLE_ITEM_11_0                        =  UNIT_END + $00C0; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_11_PROPERTIES               =  UNIT_END + $00C8; { Type: bytes }
  PLAYER_VISIBLE_ITEM_11_PAD                      =  UNIT_END + $00C9; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_12_CREATOR                  =  UNIT_END + $00CA; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_12_0                      =  8;
  PLAYER_VISIBLE_ITEM_12_0                        =  UNIT_END + $00CC; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_12_PROPERTIES               =  UNIT_END + $00D4; { Type: bytes }
  PLAYER_VISIBLE_ITEM_12_PAD                      =  UNIT_END + $00D5; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_13_CREATOR                  =  UNIT_END + $00D6; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_13_0                      =  8;
  PLAYER_VISIBLE_ITEM_13_0                        =  UNIT_END + $00D8; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_13_PROPERTIES               =  UNIT_END + $00E0; { Type: bytes }
  PLAYER_VISIBLE_ITEM_13_PAD                      =  UNIT_END + $00E1; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_14_CREATOR                  =  UNIT_END + $00E2; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_14_0                      =  8;
  PLAYER_VISIBLE_ITEM_14_0                        =  UNIT_END + $00E4; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_14_PROPERTIES               =  UNIT_END + $00EC; { Type: bytes }
  PLAYER_VISIBLE_ITEM_14_PAD                      =  UNIT_END + $00ED; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_15_CREATOR                  =  UNIT_END + $00EE; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_15_0                      =  8;
  PLAYER_VISIBLE_ITEM_15_0                        =  UNIT_END + $00F0; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_15_PROPERTIES               =  UNIT_END + $00F8; { Type: bytes }
  PLAYER_VISIBLE_ITEM_15_PAD                      =  UNIT_END + $00F9; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_16_CREATOR                  =  UNIT_END + $00FA; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_16_0                      =  8;
  PLAYER_VISIBLE_ITEM_16_0                        =  UNIT_END + $00FC; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_16_PROPERTIES               =  UNIT_END + $0104; { Type: bytes }
  PLAYER_VISIBLE_ITEM_16_PAD                      =  UNIT_END + $0105; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_17_CREATOR                  =  UNIT_END + $0106; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_17_0                      =  8;
  PLAYER_VISIBLE_ITEM_17_0                        =  UNIT_END + $0108; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_17_PROPERTIES               =  UNIT_END + $0110; { Type: bytes }
  PLAYER_VISIBLE_ITEM_17_PAD                      =  UNIT_END + $0111; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_18_CREATOR                  =  UNIT_END + $0112; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_18_0                      =  8;
  PLAYER_VISIBLE_ITEM_18_0                        =  UNIT_END + $0114; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_18_PROPERTIES               =  UNIT_END + $011C; { Type: bytes }
  PLAYER_VISIBLE_ITEM_18_PAD                      =  UNIT_END + $011D; { Type: uint32 }
  PLAYER_VISIBLE_ITEM_19_CREATOR                  =  UNIT_END + $011E; { Type: guid }

  { Repeat 8 Times }
  __PLAYER_VISIBLE_ITEM_19_0                      =  8;
  PLAYER_VISIBLE_ITEM_19_0                        =  UNIT_END + $0120; { Type: uint32 }
  { ... }

  PLAYER_VISIBLE_ITEM_19_PROPERTIES               =  UNIT_END + $0128; { Type: bytes }
  PLAYER_VISIBLE_ITEM_19_PAD                      =  UNIT_END + $0129; { Type: uint32 }

  { Repeat 46 Times }
  __PLAYER_FIELD_INV_SLOT_HEAD                    =  46;
  PLAYER_FIELD_INV_SLOT_HEAD                      =  UNIT_END + $012A; { Type: guid }
  { ... }


  { Repeat 32 Times }
  __PLAYER_FIELD_PACK_SLOT_1                      =  32;
  PLAYER_FIELD_PACK_SLOT_1                        =  UNIT_END + $0158; { Type: guid }
  { ... }


  { Repeat 48 Times }
  __PLAYER_FIELD_BANK_SLOT_1                      =  48;
  PLAYER_FIELD_BANK_SLOT_1                        =  UNIT_END + $0178; { Type: guid }
  { ... }


  { Repeat 12 Times }
  __PLAYER_FIELD_BANKBAG_SLOT_1                   =  12;
  PLAYER_FIELD_BANKBAG_SLOT_1                     =  UNIT_END + $01A8; { Type: guid }
  { ... }


  { Repeat 24 Times }
  __PLAYER_FIELD_VENDORBUYBACK_SLOT_1             =  24;
  PLAYER_FIELD_VENDORBUYBACK_SLOT_1               =  UNIT_END + $01B4; { Type: guid }
  { ... }


  { Repeat 64 Times }
  __PLAYER_FIELD_KEYRING_SLOT_1                   =  64;
  PLAYER_FIELD_KEYRING_SLOT_1                     =  UNIT_END + $01CC; { Type: guid }
  { ... }

  PLAYER_FARSIGHT                                 =  UNIT_END + $020C; { Type: guid }
  PLAYER__FIELD_COMBO_TARGET                      =  UNIT_END + $020E; { Type: guid }
  PLAYER_XP                                       =  UNIT_END + $0210; { Type: uint32 }
  PLAYER_NEXT_LEVEL_XP                            =  UNIT_END + $0211; { Type: uint32 }

  { Repeat 384 Times }
  __PLAYER_SKILL_INFO_1_1                         =  384;
  PLAYER_SKILL_INFO_1_1                           =  UNIT_END + $0212; { Type: bytes }
  { ... }

  PLAYER_CHARACTER_POINTS1                        =  UNIT_END + $0392; { Type: uint32 }
  PLAYER_CHARACTER_POINTS2                        =  UNIT_END + $0393; { Type: uint32 }
  PLAYER_TRACK_CREATURES                          =  UNIT_END + $0394; { Type: uint32 }
  PLAYER_TRACK_RESOURCES                          =  UNIT_END + $0395; { Type: uint32 }
  PLAYER_BLOCK_PERCENTAGE                         =  UNIT_END + $0396; { Type: float }
  PLAYER_DODGE_PERCENTAGE                         =  UNIT_END + $0397; { Type: float }
  PLAYER_PARRY_PERCENTAGE                         =  UNIT_END + $0398; { Type: float }
  PLAYER_CRIT_PERCENTAGE                          =  UNIT_END + $0399; { Type: float }
  PLAYER_RANGED_CRIT_PERCENTAGE                   =  UNIT_END + $039A; { Type: float }

  { Repeat 64 Times }
  __PLAYER_EXPLORED_ZONES_1                       =  64;
  PLAYER_EXPLORED_ZONES_1                         =  UNIT_END + $039B; { Type: bytes }
  { ... }

  PLAYER_REST_STATE_EXPERIENCE                    =  UNIT_END + $03DB; { Type: uint32 }
  PLAYER_FIELD_COINAGE                            =  UNIT_END + $03DC; { Type: uint32 }
  PLAYER_FIELD_POSSTAT0                           =  UNIT_END + $03DD; { Type: uint32 }
  PLAYER_FIELD_POSSTAT1                           =  UNIT_END + $03DE; { Type: uint32 }
  PLAYER_FIELD_POSSTAT2                           =  UNIT_END + $03DF; { Type: uint32 }
  PLAYER_FIELD_POSSTAT3                           =  UNIT_END + $03E0; { Type: uint32 }
  PLAYER_FIELD_POSSTAT4                           =  UNIT_END + $03E1; { Type: uint32 }
  PLAYER_FIELD_NEGSTAT0                           =  UNIT_END + $03E2; { Type: uint32 }
  PLAYER_FIELD_NEGSTAT1                           =  UNIT_END + $03E3; { Type: uint32 }
  PLAYER_FIELD_NEGSTAT2                           =  UNIT_END + $03E4; { Type: uint32 }
  PLAYER_FIELD_NEGSTAT3                           =  UNIT_END + $03E5; { Type: uint32 }
  PLAYER_FIELD_NEGSTAT4                           =  UNIT_END + $03E6; { Type: uint32 }

  { Repeat 7 Times }
  __PLAYER_FIELD_RESISTANCEBUFFMODSPOSITIVE       =  7;
  PLAYER_FIELD_RESISTANCEBUFFMODSPOSITIVE         =  UNIT_END + $03E7; { Type: uint32 }
  { ... }

  { Repeat 7 Times }
  __PLAYER_FIELD_RESISTANCEBUFFMODSNEGATIVE       =  7;
  PLAYER_FIELD_RESISTANCEBUFFMODSNEGATIVE         =  UNIT_END + $03EE; { Type: uint32 }
  { ... }


  { Repeat 7 Times }
  __PLAYER_FIELD_MOD_DAMAGE_DONE_POS              =  7;
  PLAYER_FIELD_MOD_DAMAGE_DONE_POS                =  UNIT_END + $03F5; { Type: uint32 }
  { ... }


  { Repeat 7 Times }
  __PLAYER_FIELD_MOD_DAMAGE_DONE_NEG              =  7;
  PLAYER_FIELD_MOD_DAMAGE_DONE_NEG                =  UNIT_END + $03FC; { Type: uint32 }
  { ... }


  { Repeat 7 Times }
  __PLAYER_FIELD_MOD_DAMAGE_DONE_PCT              =  7;
  PLAYER_FIELD_MOD_DAMAGE_DONE_PCT                =  UNIT_END + $0403; { Type: uint32 }
  { ... }

  PLAYER_FIELD_BYTES                              =  UNIT_END + $040A; { Type: bytes }
  PLAYER_AMMO_ID                                  =  UNIT_END + $040B; { Type: uint32 }
  PLAYER_SELF_RES_SPELL                           =  UNIT_END + $040C; { Type: uint32 }
  PLAYER_FIELD_PVP_MEDALS                         =  UNIT_END + $040D; { Type: uint32 }

  { Repeat 12 Times }
  __PLAYER_FIELD_BUYBACK_PRICE_1                  =  12;
  PLAYER_FIELD_BUYBACK_PRICE_1                    =  UNIT_END + $040E; { Type: uint32 }
  { ... }


  { Repeat 12 Times }
  __PLAYER_FIELD_BUYBACK_TIMESTAMP_1              =  12;
  PLAYER_FIELD_BUYBACK_TIMESTAMP_1                =  UNIT_END + $041A; { Type: uint32 }
  { ... }

  PLAYER_FIELD_SESSION_KILLS                      =  UNIT_END + $0426; { Type: bytes }
  PLAYER_FIELD_YESTERDAY_KILLS                    =  UNIT_END + $0427; { Type: bytes }
  PLAYER_FIELD_LAST_WEEK_KILLS                    =  UNIT_END + $0428; { Type: bytes }
  PLAYER_FIELD_THIS_WEEK_KILLS                    =  UNIT_END + $0429; { Type: bytes }
  PLAYER_FIELD_THIS_WEEK_CONTRIBUTION             =  UNIT_END + $042A; { Type: uint32 }
  PLAYER_FIELD_LIFETIME_HONORBALE_KILLS           =  UNIT_END + $042B; { Type: uint32 }
  PLAYER_FIELD_LIFETIME_DISHONORBALE_KILLS        =  UNIT_END + $042C; { Type: uint32 }
  PLAYER_FIELD_YESTERDAY_CONTRIBUTION             =  UNIT_END + $042D; { Type: uint32 }
  PLAYER_FIELD_LAST_WEEK_CONTRIBUTION             =  UNIT_END + $042E; { Type: uint32 }
  PLAYER_FIELD_LAST_WEEK_RANK                     =  UNIT_END + $042F; { Type: uint32 }
  PLAYER_FIELD_BYTES2                             =  UNIT_END + $0430; { Type: bytes }
  PLAYER_FIELD_WATCHED_FACTION_INDEX              =  UNIT_END + $0431; { Type: uint32 }

  { Repeat 20 Times }
  __PLAYER_FIELD_COMBAT_RATING_1                  =  20;
  PLAYER_FIELD_COMBAT_RATING_1                    =  UNIT_END + $0432; { Type: uint32 }
  { ... }
...
{$ELSE}
  ...
  PLAYER_FIELD_POSSTAT0                           =  UNIT_END + $044D; { Type: uint32 }
  PLAYER_FIELD_POSSTAT1                           =  UNIT_END + $044E; { Type: uint32 }
  PLAYER_FIELD_POSSTAT2                           =  UNIT_END + $044F; { Type: uint32 }
  PLAYER_FIELD_POSSTAT3                           =  UNIT_END + $0450; { Type: uint32 }
  PLAYER_FIELD_POSSTAT4                           =  UNIT_END + $0451; { Type: uint32 }
  PLAYER_FIELD_NEGSTAT0                           =  UNIT_END + $0452; { Type: uint32 }
  PLAYER_FIELD_NEGSTAT1                           =  UNIT_END + $0453; { Type: uint32 }
  PLAYER_FIELD_NEGSTAT2                           =  UNIT_END + $0454; { Type: uint32 }
  PLAYER_FIELD_NEGSTAT3                           =  UNIT_END + $0455; { Type: uint32 }
  PLAYER_FIELD_NEGSTAT4                           =  UNIT_END + $0456; { Type: uint32 }

  { Repeat 7 Times }
  __PLAYER_FIELD_RESISTANCEBUFFMODSPOSITIVE       =  7;
  PLAYER_FIELD_RESISTANCEBUFFMODSPOSITIVE         =  UNIT_END + $0457; { Type: uint32 }
  { ... }


  { Repeat 7 Times }
  __PLAYER_FIELD_RESISTANCEBUFFMODSNEGATIVE       =  7;
  PLAYER_FIELD_RESISTANCEBUFFMODSNEGATIVE         =  UNIT_END + $045E; { Type: uint32 }
  { ... }


  { Repeat 7 Times }
  __PLAYER_FIELD_MOD_DAMAGE_DONE_POS              =  7;
  PLAYER_FIELD_MOD_DAMAGE_DONE_POS                =  UNIT_END + $0465; { Type: uint32 }
  { ... }


  { Repeat 7 Times }
  __PLAYER_FIELD_MOD_DAMAGE_DONE_NEG              =  7;
  PLAYER_FIELD_MOD_DAMAGE_DONE_NEG                =  UNIT_END + $046C; { Type: uint32 }
  { ... }


  { Repeat 7 Times }
  __PLAYER_FIELD_MOD_DAMAGE_DONE_PCT              =  7;
  PLAYER_FIELD_MOD_DAMAGE_DONE_PCT                =  UNIT_END + $0473; { Type: uint32 }
  { ... }

  PLAYER_FIELD_MOD_HEALING_DONE_POS               =  UNIT_END + $047A; { Type: uint32 }
  PLAYER_FIELD_MOD_TARGET_RESISTANCE              =  UNIT_END + $047B; { Type: uint32 }
  PLAYER_FIELD_BYTES                              =  UNIT_END + $047C; { Type: bytes }
  PLAYER_AMMO_ID                                  =  UNIT_END + $047D; { Type: uint32 }
  PLAYER_SELF_RES_SPELL                           =  UNIT_END + $047E; { Type: uint32 }
  PLAYER_FIELD_PVP_MEDALS                         =  UNIT_END + $047F; { Type: uint32 }

  { Repeat 12 Times }
  __PLAYER_FIELD_BUYBACK_PRICE_1                  =  12;
  PLAYER_FIELD_BUYBACK_PRICE_1                    =  UNIT_END + $0480; { Type: uint32 }
  { ... }


  { Repeat 12 Times }
  __PLAYER_FIELD_BUYBACK_TIMESTAMP_1              =  12;
  PLAYER_FIELD_BUYBACK_TIMESTAMP_1                =  UNIT_END + $048C; { Type: uint32 }
  { ... }

  PLAYER_FIELD_TODAY_KILLS                        =  UNIT_END + $0498; { Type: bytes }
  PLAYER_FIELD_YESTERDAY_KILLS                    =  UNIT_END + $0499; { Type: bytes }
  PLAYER_FIELD_LIFETIME_HONORBALE_KILLS           =  UNIT_END + $049A; { Type: uint32 }
  PLAYER_FIELD_BYTES2                             =  UNIT_END + $049B; { Type: bytes }
  PLAYER_FIELD_WATCHED_FACTION_INDEX              =  UNIT_END + $049C; { Type: uint32 }

  { Repeat 23 Times }
  __PLAYER_FIELD_COMBAT_RATING_1                  =  23;
  PLAYER_FIELD_COMBAT_RATING_1                    =  UNIT_END + $049D; { Type: uint32 }
  { ... }


  { Repeat 9 Times }
  __PLAYER_FIELD_ARENA_TEAM_INFO_1_1              =  9;
  PLAYER_FIELD_ARENA_TEAM_INFO_1_1                =  UNIT_END + $04B4; { Type: uint32 }
  { ... }

  PLAYER_FIELD_HONOR_CURRENCY                     =  UNIT_END + $04BD; { Type: uint32 }
  PLAYER_FIELD_ARENA_CURRENCY                     =  UNIT_END + $04BE; { Type: uint32 }
  PLAYER_FIELD_PADDING                            =  UNIT_END + $04BF; { Type: uint32 }
...
{$IFNDEF WOW_TBC}
  ...
  GAMEOBJECT_CREATED_BY                           =  OBJECT_END + $0000; { Type: guid }
