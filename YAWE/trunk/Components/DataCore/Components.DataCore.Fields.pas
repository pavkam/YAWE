...
const
  ...
  FIELD_ITM_MOD_RANGE            : string = 'FRANGEMOD';
  ...
  FIELD_ITM_UNK_1                : string = 'IUNK1';
  FIELD_ITM_UNK_2                : string = 'IUNK2';          //added in 1.11.X
  FIELD_ITM_UNK_3                : string = 'IUNK3';          //added in 1.11.X
