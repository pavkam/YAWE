...
type
  ...
  ucl_progress_callback_t = record
    Callback: procedure(TextSize: Cardinal; CodeSize: Cardinal; State: Integer; User: Pointer); cdecl;
    User: Pointer;
  end;
...
{ Should be the first function you call. Check the return code! }
...
function ucl_output_block_size(const input_block_size: Cardinal): Cardinal; inline;
